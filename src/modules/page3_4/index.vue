...
<template>
	<div> 
    <!---------------------------------------------------------------->
    <main class="main-container" v-show="part_d">
    	<c-todonew></c-todonew>
    </main>
    <!---------------------------------------------------------------->
  </div>
...
<script>
  import $ from 'jquery'
  import CTodonew from 'modules/page3_4/components/To_add'
    ...
    data() {
  	...
  	mounted(){
  		this.$nextTick(function() {  
  		     this.origin_background();
  		})
  	},
    methods: {
        origin_background:function(){
        	$("#p3_first").addClass("select");
        }
