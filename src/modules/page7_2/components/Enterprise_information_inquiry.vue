...
<template>
	<div> 
		...
		<div class="vue_location">
			...
			<div class="page_location_content" v-text="location_new"></div>
		</div>
		<!----------------------------->
		<div class="form_area">
  ...
  export default {
    data() {
      ...
      return {
        ...
        task:"任务转移",
        search_new:"搜索",
        location_new:"您的位置    >  流程任务查询    >  已归档任务查询",
        search_form:{
        	value1:'',
        	value2:'',
        	value3:'',
    ...
    methods: {
    	    ...
    	    this.url=localStorage.localhost+'/ArchiveTaskFacade/getArchivedTaskList';
