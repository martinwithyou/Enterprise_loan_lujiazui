    ...
    <div class="sidebar-scroll">
      <div class="sidebar-content">
        <div class="side-content">
          <ul class="nav-main">
              <li class="nav-main-heading sidebar-title" id="p4_first" @click="partShow_a">
                <span class="sidebar-mini-hide" v-text="title_1"></span>
              </li>
              <li class="nav-main-heading sidebar-title" id="p4_second" @click="partShow_b">
...
<script>
	import $ from 'jquery'
  import CEnterpriseInformationInquiry from 'modules/page4_2/components/Enterprise_information_inquiry'
  export default {
  	components:{
