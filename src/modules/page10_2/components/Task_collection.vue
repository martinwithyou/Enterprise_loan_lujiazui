...
<el-row class="change_row_size">
   <el-col :span="8">
  	<div class="grid-content bg-purple">
  	    <el-form-item label="进件渠道">
           <select id="select_choice"  placeholder="进件渠道" class="select_style" ></select>
        </el-form-item>
    </div>
   </el-col>
    ...
    <el-col :span="8">
  	<div class="grid-content bg-purple">
  		<el-form-item label="当前还款状态">
            <select id="currRepayStatus" class="select_style">
            	<option>请选择</option>
            	<option val="0">未还款</option>
            	<option val="1">已还款</option>
            </select>
        </el-form-item>
  	</div>
  </el-col>
  ...
  <el-col :span="8">
  	<div class="grid-content bg-purple">
  		<el-form-item label="逾期状态">
            <select id="overDueStatus" class="select_style">
            	<option>请选择</option>
            	<option val="0">未逾期</option>
            	<option val="1">已逾期</option>
            </select>
        </el-form-item>
  	</div>
  </el-col>
  ...
  <el-col :span="8">
  	<div class="grid-content bg-purple">
  		<el-form-item label="放款开始日期">
            <el-date-picker
            v-model="ruleForm.loanStartDate"
            type="date"
            placeholder="签约开始日期">
            </el-date-picker>
        </el-form-item>
  ...
  <el-col :span="8">
  	<div class="grid-content bg-purple">
  		<el-form-item label="放款结束日期">
            <el-date-picker
            v-model="ruleForm.loanEndDate"
            type="date"
            placeholder="签约结束日期">
            </el-date-picker>
        </el-form-item>
...
<!----------------------------->
  ...
  <!-------------------------------->          
            ...
            <el-table-column
            prop="residuePrincipal"
            label="剩余本金"
            width="200">
            </el-table-column>
            
            <el-table-column
            prop="residueInterest"
            label="剩余利息"
            width="200">
            </el-table-column>
...
//  	    	console.log(btnCode);
    	    	if(btnCode=="query_btn"){
    	    		this.query_btn();
    	    	}else if(btnCode=="export_btn"){
    	    		var url=localStorage.localhost+'/reportManageFacade/postLoanRepayDetailExport';
    	    ...
    	    search_data: function(){
                	...
                	this.url=localStorage.localhost+'/reportManageFacade/getApplyApproveDetail';
                	
                    this.criteria={};
                    
                    this.criteria=this.ruleForm;
                    
                    var s_time = new Date(this.criteria.contractStartDate);
                    ...
                    var s_time = new Date(this.criteria.contractEndDate);
                    var y = s_time.getFullYear();
                    var m = s_time.getMonth()+1;
                    if(m<10){
                 	   m='0'+m;
                   ...
                   this.criteria.contractEndDate=y+'-'+m+'-'+d;
                   
                    var s_time = new Date(this.criteria.loanStartDate);
                    var y = s_time.getFullYear();
                    var m = s_time.getMonth()+1;
                    if(m<10){
                 	   m='0'+m;
                   ...
                   this.criteria.loanStartDate=y+'-'+m+'-'+d;
                   
                    var s_time = new Date(this.criteria.loanEndDate);
                    var y = s_time.getFullYear();
                    var m = s_time.getMonth()+1;
                    if(m<10){
                 	   m='0'+m;
                    ...
                    this.criteria.loanEndDate=y+'-'+m+'-'+d;

                    this.criteria.iPiecesChannel=$("#select_choice").val();
                    
                    this.criteria.currRepayStatus=$("#currRepayStatus").val();
                    
                    this.criteria.overDueStatus=$("#overDueStatus").val();
            ...
            var selelct_url=localStorage.localhost+'/reportManageFacade/gotoReportManage'
...
//              console.log(res);
               for(var i=0; i<res.body.data.organList.length;i++){
               	//select_choice
               	  $("#select_choice").append('<option value="'+res.body.data.organList[i].companyCode+'">'+res.body.data.organList[i].companyName+'</option>');
               }
    	    ...
    	    load_button:function(){
                ...
                loadData: function(){ 
                	...
                	this.url=localStorage.localhost+'/reportManageFacade/getPostLoanRepaydetail'
